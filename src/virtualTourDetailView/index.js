...
let jwtToken=""
class VirtualTourDetailView extends Component{
    state={referenceImagesList:initialreferenceImagesList,singleProductData:[],splitedImages:[],activeIndex:0}

    getProductsData= async()=>{
        const currentPath = window.location.pathname;
        const splitTourId=currentPath.split(":")
        const currentTourId=splitTourId[1]
        ...
        if(response.ok===true){
            ...
            console.log(data)
            const splitedImages=data.thumbnail_image
            .split(",");
                ...
                <Row>
                    ...
                    <Col md={6}>
                       <div className='descDiv'>
                        <h5>{singleProductData.tour_name}</h5>
...
export default VirtualTourDetailView