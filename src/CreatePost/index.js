...
class CreatePost extends Component{
    ...
    filterUser=async(event)=>{
       ...
       const searchingResult=userProfiles.filter(eachItem=>
        ...
        const searchApi="https://venkatsai.onrender.com/selectedUsers";
        const options={
            method:"POST",
            headers:{
    ...
    componentDidMount=async()=>{
        const apiUrl="https://venkatsai.onrender.com/relatedUsers";
        const options={
             methos:"GET"
        }
    ...
    onClickPost=async()=>{
        ...
        const url= "https://venkatsai.onrender.com/post"
