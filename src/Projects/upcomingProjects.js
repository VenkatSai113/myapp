...
import UpComingProjectCard from "./upComingProjectCards";
    ...
    render(){
        ...
        return(
            <div className="projects-bg-container">
               ...
               <p className="project-heading">Upcoming Project</p>
                ...
                <div className="project-cards-container">
                    {searchResult.map(eachCard=>
                        <UpComingProjectCard cardItem={eachCard} key={eachCard.id}/>)}
                </div>
               </div>
            </div>
        )
